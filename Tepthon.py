...
async def _(event):
    ...
    await event.edit("Speed - جاري الفحص....")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك سبيد ابشر  @s_x_t')
...
async def _(event):
      await event.reply("""السـورس يعمـل يعمل بنجاح @s_x_t
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍


- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها 
- للدخول الي سورس المطور تفضل - @TopThon .
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@Tepthon.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""Speed : @s_x_t"""
)
